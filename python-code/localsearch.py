...
def hillClimbingLocalSearch(original_lst, size, max_iteration):
	...
	for i in range(max_iteration):
		new_random_solution = copy.deepcopy(random_solution)
...
def simulatedAnnealingLocalSearch(original_lst, size, max_iteration):
	random_solution = randomSol(size)
	...
	for i in range(max_iteration):
		...
		if prior_residue < original_residue:
			random_solution2 = copy.deepcopy(random_solution)
			original_residue = prior_residue

	return random_solution2

def repeatedRandomLocalSearch(original_lst, size, max_iteration):
	random_solution = randomSol(size)
	new_input = newInput(original_lst, random_solution, size)
...
#***********************************************************************************
def standardHillClimbingLocalSearch(original_lst, size, max_iteration):
	...
	for i in range(max_iteration):
		new_random_solution = copy.deepcopy(random_solution)
		new_random_solution = randomMove2(new_random_solution, size)
		

		new_residue = karp2(original_lst, random_solution, size)
...
def standardSimulatedAnnealingLocalSearch(original_lst, size, max_iteration):
	random_solution = randomSol2(size)
	random_solution2 = random_solution
...
def standardRepeatedRandomLocalSearch(original_lst, size, max_iteration):
	random_solution = randomSol2(size)
	...
	for i in range(max_iteration):
		...
		if new_residue < prior_residue:
			prior_residue = new_residue
			random_solution = copy.deepcopy(new_random_solution)
...
solution1 = repeatedRandomLocalSearch(original_lst, size, max_iteration)
# print solution1
...
solution2 = hillClimbingLocalSearch(original_lst, size, max_iteration)
# print solution2
...
solution3 = simulatedAnnealingLocalSearch(original_lst, size, max_iteration)
# print solution3
...
standard_solution1 = standardRepeatedRandomLocalSearch(original_lst, size, max_iteration)
# print standard_solution1
print(karp2(original_lst, standard_solution1, size))

print("standard hill climbing results")
standard_solution2 = standardHillClimbingLocalSearch(original_lst, size, max_iteration)
# print standard_solution2
print(karp2(original_lst, standard_solution2, size))

print("standard simulated annealing results")
standard_solution3 = standardSimulatedAnnealingLocalSearch(original_lst, size, max_iteration)
